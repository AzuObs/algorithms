...
//import com.algorithms.collections.map.MapHashChaining;
//import com.algorithms.controls.option.Option;
//
//public class SetHashChaining<T> implements Set<T> {
//    private MapHashChaining<List<T>> underlying;
//    private int population;
//
//    private SetHashChaining(T[] elements) {
...
//
//    @SafeVarargs
//    public static <T> SetHashChaining<T> apply(T... elements) {
//        return new SetHashChaining(elements);
//    }
//
//    @Override
...
//
//    @Override
//    public SetHashChaining<T> remove(T element) {
...
//
//    @Override
//    public SetHashChaining<T> add(T element) {
