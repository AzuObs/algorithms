...
public class SetHashProbeTest {
    
    @Test
    public void isApplicative() {
        SetHashProbe.apply(1, 2, 3);
    }

    @Test
    public void get() {
        var set = SetHashProbe.apply(1, 2, 3);
    ...
    @Test
    public void remove() {
        var set = SetHashProbe.apply(1, 2, 3, 5, 6, 10);
